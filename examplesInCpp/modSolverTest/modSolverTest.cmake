...
file(GLOB MODSOLVER_TEST_INC_TD  ${MY_INC}/td/*.h)
file(GLOB MODSOLVER_TEST_INC_CNT  ${MY_INC}/cnt/*.h)
file(GLOB MODSOLVER_TEST_INC_MU  ${MY_INC}/mu/*.h)
file(GLOB MODSOLVER_TEST_INC_SC  ${MY_INC}/sc/*.h)
file(GLOB MODSOLVER_TEST_INC_SC_PRIV  ${MY_INC}/sc/priv/*.h)
file(GLOB MODSOLVER_TEST_INC_MATH  ${MY_INC}/math/*.h)
file(GLOB MODSOLVER_TEST_INC_MEM  ${MY_INC}/mem/*.h)
file(GLOB MODSOLVER_TEST_INC_RND  ${MY_INC}/rnd/*.h)
file(GLOB MODSOLVER_TEST_INC_RND_PRIV  ${MY_INC}/rnd/priv/*.h)

file(GLOB MODSOLVER_TEST_INC_SYST ${MY_INC}/syst/*.h)
